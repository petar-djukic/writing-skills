...
- `scripts/md_paragraphs.py` — paragraph extraction and line
  classification.
- `scripts/prose_document.py` — the document model markers survive.
- `scripts/span_locks.py` — the lock contract `annotate` respects.
