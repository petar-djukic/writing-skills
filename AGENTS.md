...
Reusable skills (17): accent-dial, audit-references, critic-panel, filter-tells, humanize, inject-vernacular, match-outline, match-structure, match-voice, patent-disclosure, pattern-language, reverse-outline, review-chapter, tighten-style, tune-anchors, update-references, voice-critic.
