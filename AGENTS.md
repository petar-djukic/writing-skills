...
Reusable skills (18): accent-dial, audit-references, cold-review, critic-apply, critic-panel, filter-tells, humanize, inject-vernacular, match-outline, match-structure, match-voice, patent-disclosure, pattern-language, reverse-outline, tighten-style, tune-anchors, update-references, voice-critic.
