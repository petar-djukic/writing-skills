...
- `.agents/scripts/md_paragraphs.py` — paragraph extraction and line
  classification.
- `.agents/scripts/prose_document.py` — the document model markers survive.
- `.agents/scripts/span_locks.py` — the lock contract `annotate` respects.
